...
export default function Empresa() {
  ...
  return (
    <div className="t-container">
      ...
      <h2 className="t-subtitulo">Lista de Empresas</h2>
        ...
        <tbody>
          {vm.empresasFiltradas.map((e) => (
            <tr key={e.id}>
              ...
              <td>
                <span className={`t-status ${e.status.toLowerCase()}`}>
                  {e.status}
                </span>
              </td>
              <td>
                <div className="t-acoes">
                  <button
                    onClick={() => vm.abrirModal("formulario", e)}
                    className="t-atualizar"
                  >
                    <Pencil size={16} />
                  </button>
                  <button
                    onClick={() => vm.abrirModal("delete", e)}
                    className="t-remover"
                  >
                    <Trash2 size={16} />
                  </button>
