      ...
      <div className="home-info-dia">
        ...
        <div className="home-info-grid">
          <div className="home-info-card">
            ...
            <div className="home-info-value">{clima.temp !== null ? `${clima.temp}°C` : "..."}</div>
          </div>
          <div className="home-info-card">
            <div className="home-info-label">Clima</div>
            <div className="home-info-value">{clima.desc || "..."}</div>
          </div>
          <div className="home-info-card">
            <div className="home-info-label">Movimentação</div>
            <div className={`home-info-value ${indicadores.movimentacao.classe}`}>
      ...
      <div className="home-cards-grid">
        <div className="home-card">
          <div className="home-card-info">
            ...
            <span className="home-card-number">{indicadores.noPatio}</span>
          </div>
        ...
        <div className="home-card">
          <div className="home-card-info">
            <h4>Entradas Hoje</h4>
            <span className="home-card-number">{indicadores.entradasHoje}</span>
          </div>
        ...
        <div className="home-card">
          <div className="home-card-info">
            <h4>Saídas Hoje</h4>
            <span className="home-card-number">{indicadores.saidasHoje}</span>
          </div>
        ...
        <div className="home-card">
          <div className="home-card-info">
            <h4>Motoristas</h4>
            <span className="home-card-number">{indicadores.totalMotoristas}</span>
          </div>
          ...
          <tbody>
            {ultimasMovimentacoes.map((r) => (
              <tr key={r.id}>
                ...
                <td>
                  <span className={r.tipo === "Entrada" ? "tipo-entrada" : "tipo-saida"}>{r.tipo}</span>
                </td>
                <td>
                  <span className={r.status === "No Pátio" ? "status-patio" : "status-finalizado"}>{r.status}</span>
                </td>
